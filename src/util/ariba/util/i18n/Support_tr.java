/*
    ...
    $Id: //ariba/platform/util/core/ariba/util/i18n/Support_tr.java#1 $
*/
...
public class Support_tr extends I18NSupport
{
    /*-----------------------------------------------------------------------
        Public Methods
      -----------------------------------------------------------------------*/
    ...
    */
    ...
    {
        return I18NConstants.IANACharset[I18NConstants.Cp1254];
    }
    ...
    */
    ...
    {
        return I18NConstants.CharacterEncoding[I18NConstants.Cp1254];
    }
