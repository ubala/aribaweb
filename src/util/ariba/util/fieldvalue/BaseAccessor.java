/*
    ...
    $Id: //ariba/platform/util/core/ariba/util/fieldvalue/BaseAccessor.java#2 $
*/

package ariba.util.fieldvalue;

/**
The BaseAccessor class is a base class that serves as the base for
...
*/
abstract public class BaseAccessor extends Object implements FieldValueAccessor
{
    protected final Class _forClass;
    protected final String _fieldName;

    /**
    Constructs a new accessor which applies for the class 'forClass' and the field named fieldName.
    */
    protected BaseAccessor (Class forClass, String fieldName)
    {
        super();
        _forClass = forClass;
