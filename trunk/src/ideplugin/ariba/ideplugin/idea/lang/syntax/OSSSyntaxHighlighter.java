/*
    ...
    $Id://ariba/platform/ui/ideplugin/ariba/ideplugin/idea/lang/syntax
    /OSSSyntaxHighlighter.java $
*/
...
public class OSSSyntaxHighlighter extends SyntaxHighlighterBase
{
    ...
    static {
        ...
        keys1.put(STRING_LITERAL, SyntaxHighlighterColors.STRING);
        keys1.put(SQ_STRING_LITERAL, SyntaxHighlighterColors.STRING);
        keys1.put(LOCALIZED_STRING, SyntaxHighlighterColors.STRING);
        keys1.put(INT_LITERAL, SyntaxHighlighterColors.NUMBER);
        keys1.put(FLT_LITERAL, SyntaxHighlighterColors.NUMBER);
        keys1.put(EXPR_LITERAL, SyntaxHighlighterColors.OPERATION_SIGN);
        keys1.put(DYN_FIELDPATHBINDING, SyntaxHighlighterColors.OPERATION_SIGN);
        keys1.put(KEY_PATH, SyntaxHighlighterColors.OPERATION_SIGN);

        keys1.put(OSSTypes.BLOCK_COMMENT, BLOCK_COMMENT);
        keys1.put(OSSTypes.LINE_COMMENT, LINE_COMMENT);
        keys1.put(AT, KEYWORD);

        keys1.put(OSSTypes.LEFT_PARENTH, SyntaxHighlighterColors.PARENTHS);
        keys1.put(OSSTypes.RIGHT_PARENTH, SyntaxHighlighterColors.PARENTHS);

        keys1.put(OSSTypes.LEFT_BRACE, SyntaxHighlighterColors.BRACES);
        keys1.put(OSSTypes.RIGHT_BRACE, SyntaxHighlighterColors.BRACES);

        keys1.put(OSSTypes.LEFT_BRACKET, SyntaxHighlighterColors.BRACKETS);

        keys1.put(OSSTypes.RIGHT_BRACKET, SyntaxHighlighterColors.BRACKETS);
        keys1.put(com.intellij.psi.TokenType.BAD_CHARACTER,
                HighlighterColors.BAD_CHARACTER);

        keys1.put(LOCALIZATION_KEY, SyntaxHighlighterColors.KEYWORD);
        keys1.put(HASH, DefaultLanguageHighlighterColors.CLASS_NAME);

        keys1.put(COMA, SyntaxHighlighterColors.COMMA);
        keys1.put(DOT, SyntaxHighlighterColors.DOT);
        keys1.put(SEMI, SyntaxHighlighterColors.JAVA_SEMICOLON);
