/*
    ...
    $Id: //ariba/platform/util/core/ariba/util/i18n/Support_hu.java#1 $
*/
...
/**
    default i18n for Hungarian

    @aribaapi private
*/

public class Support_hu extends I18NSupport
{
    /*-----------------------------------------------------------------------
        Public Methods
      -----------------------------------------------------------------------*/
    ...
    */
    ...
    {
        return I18NConstants.IANACharset[I18NConstants.Cp1250];
    }
    ...
    */
    ...
    {
        return I18NConstants.CharacterEncoding[I18NConstants.Cp1250];
    }
