/*
    ...
    $Id: //ariba/platform/ui/aribaweb/ariba/ui/aribaweb/core/AWSessionValidator.java#5 $
*/
...
public interface AWSessionValidator
{
    ...
    AWResponseGenerating handleSessionValidationError (
        AWRequestContext requestContext, Exception exception);

    AWResponseGenerating handleComponentActionSessionValidationError (
        AWRequestContext requestContext, Exception exception);
