/*
    ...
    $Id: //ariba/platform/ui/metaui-jpa/examples/appcore/ariba/appcore/util/LoginPage.java#2 $
*/
...
public class LoginPage extends AWComponent
{
    ...
    public AWResponseGenerating login ()
    {
        ...
        if (user == null) {
            recordValidationError("username", "Unknown user", _userName);
        } else {
            ...
            recordValidationError("password", "Invalid credentials", null);
        }
